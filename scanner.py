...
CLOSED_SOCKETS = []
PORT_LIST = [ 443, 587, 143, 25, 110, 995, 993, 465, 3389, 1433, 10022, 22, 4444, 14444, 10000, 20000, 2087, 2083, 2086, 2087, 2096, 7777 ]
...
if __name__ == '__main__':
    ...
    for cipher_suite in cipher_suites:
        print 'Testing Cipher: %s' % (cipher_suite)
        for port in PORT_LIST:
            if port in CLOSED_SOCKETS: # If the Port has been marked as Closed in a previous iteration
                continue
            print 'Port #%s' %( port )
